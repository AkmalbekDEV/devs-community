...
const Projects = () => {
    ...
    return (
        <div className='text-white'>
            ...
            <div className='grid grid-cols-4 max-sm:grid-cols-1 max-sm:gap-[50px] text-center gap-[200px] flex-wrap text-white mt-16'>
                {state.map((product) => {
                    return (
                        <div className='max-sm:flex max-sm:justify-center'>
                            <div key={product.id} className='w-[280px] grid gap-5' data-aos="fade-right">
                                <img src={product.pic} alt="" className='rounded-xl' />
